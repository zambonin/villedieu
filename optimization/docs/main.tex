...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Approximation algorithms are provably bounded to find solutions within some ``distance'' compared to solutions of the original problems. This is equivalent to the idea that the approximate solution returned hash, in the worst case, 
  \end{enumerate}
\end{enumerate}

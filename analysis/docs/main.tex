...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item $n! \in \mathcal{O}(n^{n - 47})$, for $n_{0} > 10^{100}$ and $c = 1$.
    ...
    \begin{enumerate}
        ...
        \begin{figure}[htbp]
          ...
          \end{tikzpicture}
        \end{figure}
        The costs are given shortly after. The recurrence is solved by the iteration method. Indeed, the maximum value of $i = \lg n$, and the dominant term in the summation is $n^{\lg n} 2^{-\frac{1}{2}\lg n(\lg n - 1)}$. Assuming that the input size is a power of 2 and substituting $n = 2^{k}, k \in \mathbb{N}$,
        \begin{align*}

...
\begin{enumerate}
  ...
  \begin{enumerate}\label{ex:2a}
    ...
    \item
    \begin{enumerate}
      \item $(\log n)^{\log n} \in \Omega(\frac{n}{\log n})$, for $n_{0} > 1$ and $c = 1$. Indeed, this is confirmed by the limit $\lim_{n\to\infty} \frac{(\log n)^{\log n + 1}}{n} = \infty$.
      \item $n^{2} \in \Omega(n^{\frac{1}{2}})$, for $n_{0} > 1$ and $c = 1$. Indeed, this is confirmed by the limit $\lim_{n\to\infty} \frac{n^{2}}{\sqrt{n}} = \infty$. 
      \item $n! \in \mathcal{O}(n^{n - 47})$, for $n_{0} > 10^{100}$ and $c = 1$. Indeed, this is confirmed by the limit $\lim_{n\to\infty} \frac{n!}{n^{n - 47}} = 0$.
      \item $2^{{(\lg n)}^{2}} \in \Omega((\log n)^{\log n})$, for $n_{0} > 1$ and $c = 1$. Indeed, this is confirmed by the limit $\lim_{n\to\infty} \frac{2^{{(\lg n)}^{2}}}{(\log n)^{\log n}} = \infty$.
      \item $n^{2} \in \Theta(n + n^{2})$, for $n_{0} > 1, c_{1} = \frac{1}{2}$ and $c_{2} = 1$. Indeed, this is confirmed by the limit $\lim_{n\to\infty} \frac{n^{2}}{n + n^{2}} = 1$.
      \item $n + (\log n)^{2} \in \Theta(10n + \lg n)$, for $n_{0} > 1, c_{1} = 1$ and $c_{2} = \frac{1}{11}$. Indeed, this is confirmed by the limit $\lim_{n\to\infty} \frac{n + (\log n)^{2}}{10n + \lg n} = \frac{1}{10}$.
      \item $\log 2n \in \Theta(\log 3n)$, for $n_{0} > 1, c_{1} = \frac{1}{2}$ and $c_{2} = 1$. Indeed, this is confirmed by the limit $\lim_{n\to\infty} \frac{\log 2n}{\log 3n} = 1$.
      \item $n (\log n)^{2} \in \mathcal{O}(\frac{n^{2}}{\log n})$, for $n_{0} > 2$ and $c = 1$. Indeed, this is confirmed by the limit $\lim_{n\to\infty} \frac{(\log n)^{3}}{n} = 0$.
    \end{enumerate}
  \end{enumerate}
  \item
  \begin{enumerate}

...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{align*}
      P(k) + (k + 1)^{2} &\posseq P(k + 1) \\
      \frac{k (k + 1) (2k + 1)}{6} + (k + 1)^{2} &\posseq \\
      \frac{k (k + 1) (2k + 1) + 6(k + 1)^{2}}{6} &\posseq \\
      \frac{(k + 1)(k(2k + 1) + 6(k + 1))}{6} &\posseq \\
      \frac{(k + 1)(2k^2 + 7k + 6)}{6} &\posseq P(k + 1) \\
      &\posseq \frac{(k + 1)((k + 1) + 1)(2(k + 1) + 1)}{6} \\
    ...
    \begin{align*}
      P(k) + (k + 1)^{3} &\posseq P(k + 1) \\
      \frac{k^{2} (k + 1)^{2}}{4} + (k + 1)^{3} &\posseq \\
      \frac{k^{2} (k + 1)^{2} + 4(k + 1)^{3}}{4} &\posseq \\
      \frac{(k^{2} + 4(k + 1))(k + 1)^{2}}{4} &\posseq \\
      \frac{(k^{2} + 4k + 4)(k + 1)^{2}}{4} &\posseq \\

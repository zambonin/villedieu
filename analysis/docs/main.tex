...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        Let $t_1 = \frac{2^n}{s}$ be the running time for the old computer and $t_2 = \frac{2^n}{20s}$ for the new one, with $s$ being the number of instructions that the old computer executes per minute. Let's compare the running times if the new computer is running an instane

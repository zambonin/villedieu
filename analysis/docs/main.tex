...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{figure}[htbp]
          ...
          \end{tikzpicture}
        \end{figure}
        The costs are given shortly after. The recurrence is solved by the iteration method. Indeed, the maximum value of $i = \lg n$, and the dominant term in the summation is $n^{\lg n} 2^{-\frac{1}{2}\lg n(\lg n - 1)}$. Thus, $T(n) \in \Omega(n^{\lg n})$.
        \begin{align*}
            T(1) &= 0 \\

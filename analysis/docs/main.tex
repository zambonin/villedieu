...
\begin{enumerate}
    ...
    \item
    \begin{enumerate}
        \item Let $t_{1}, \dots, t_{7}$ be
        the number of seconds in each period of the header row and $s = 10^{10}$. The table below shows the largest $n \in \mathbb{N}$ such that $t \leq \frac{f(n)}{s}$.
        \begin{table}[htbp]

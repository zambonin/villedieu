...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            &= 2n(\tfrac{3}{2}^{\log_{2} n} \cdot \tfrac{3}{2} - 1) + 3^{\log_{2} n} \\
            &= 2n(n^{\log_{2} \tfrac{3}{2}} \cdot \tfrac{3}{2} - 1) + n^{\log_{2} 3} \\
            &= 2nn^{\log_{2} 3 - 1} \cdot \tfrac{6n}{2} - 2n + n^{\log_{2} 3} \\
            &= 2n^{\log_{2} 3} \cdot - 2n + n^{\log_{2} 3} \\

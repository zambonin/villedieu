...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        $r$ actually represents the speed up of the new computer, with a larger instance of the problem. The new computer will run slower with $n > 4$. This is due to the fact that the complexity of the problem grows exponential while the 
    ...
    \begin{enumerate}
        ...
        \end{align*}
        To prove the final formula by weak induction, let $T(n) = n^{\log_{2} 3 - 1}$.
    \end{enumerate}
\end{enumerate}

...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Let $T(n) = 2T(\frac{n}{2}) + \Theta(n)$. By the recursion-tree method, the total cost for $T(n)$ is the height of the tree times the cost of each level, or $T(n) \in \Theta(n \log_2 n)$.
        \begin{figure}[htbp]
          \centering
          \begin{tikzpicture}
          ...
          \end{tikzpicture}
        \end{figure}
    \item Let $T(n) = 3T(\lfloor\frac{n}{2}\rfloor) + \Theta(n)$. By the recursion-tree method, $T(n) = n\sum_{i = 0}^{\log_{2} n} (\tfrac{3}{2})^{i} + n^{\log_{2} 3} + \Theta(n)$. As per Exercise~\ref{ex:4d}, $T(n) \in \Theta(\text{poly}(n))$.
        \begin{figure}[htbp]
          \centering
          \begin{tikzpicture}
          ...
          \end{tikzpicture}
        \end{figure}
    \item Let $T(n) = 4T(\lfloor\frac{n}{2}\rfloor) + \Theta(n)$. By the recursion-tree method and using the sum of geometric series, 
    \begin{align*}
        T(n) &= n^{2} + n\sum_{i = 0}^{\log_{2} n} (2^{i + 1} - 2^{i}) \\
        &= n^{2} + n\sum_{i = 0}^{\log_{2} n} (2^{i + 1} - 2^{i}) \\
        &= n^{2} + n(\sum_{i = 0}^{\log_{2} n} 2^{i + 1} - \sum_{i = 0}^{\log_{2} n} 2^{i}) \\
        &= n^{2} + 
    \end{align*}
        \begin{figure}[htbp]
          \centering
          ...
          \end{tikzpicture}
        \end{figure}
    \item Let $T(n) = 2T(\frac{n}{2}) + \Theta(n^{2})$.
    \item Let $T(n) = 2T(\frac{n}{3}) + \Theta(n)$.
    \end{enumerate}
\end{enumerate}

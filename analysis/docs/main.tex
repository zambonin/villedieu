...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            T(n) &\in \Theta(2^{n}).
        \end{align*}
        To prove the final formula by weak induction, let $T(n) = (n - 1)2^{n - 1}$. $T(1)$ holds, since $(1 - 1)2^{1} = 0$. The inductive step is proved below, using the hypothesis that $T(n - 1)$ is true.
        \begin{align*}

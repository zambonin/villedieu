...
\begin{enumerate}
    ...
    \item
    \begin{enumerate}
        \item Let $T(n) = 2T(\frac{n}{2}) + \Theta(n)$. By the recursion-tree method, we have that the total cost for $T(n)$ is the height of the tree times the cost of each level, or $T(n) \in \Theta(n \log_2 n)$.
        \begin{figure}[htbp]
          \centering
          \begin{tikzpicture}
          ...
          \end{tikzpicture}
        \end{figure}
    \item Let $T(n) = 3T(\lfloor\frac{n}{2}\rfloor) + \Theta(n)$. The floor function is disregarded for simplicity.
        \begin{figure}[htbp]
          \centering
          \begin{tikzpicture}
          ...
          \end{scope}
          \begin{scope}[->, dashed]
            \draw (n0) edge node[fill=white] {1} (c0);
            \draw (n1) -- (c1);
            \draw (n2) -- (c2);
            \draw (n3) -- (c3);
          \end{scope}
          \end{tikzpicture}
        \end{figure}
    \item Let $T(n) = 4T(\lfloor\frac{n}{2}\rfloor) + \Theta(n)$. The floor function is disregarded for simplicity.

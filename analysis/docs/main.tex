...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item
        \begin{enumerate}
            \item $(\ln n)^{\ln n} \in \Omega(\frac{n}{\ln n})$.
            \item $n^{2} \in \Omega(n^{\frac{1}{2}})$.
            \item $n! \in \Omega(n^{n - 47})$.
            \item $2^{{\log n}^{2}} \in \Omega((\ln n)^{\ln n})$.
            \item $n^{2} \in \Theta(n + n^{2})$.
            \item $n + (\ln n)^{2} \in \Theta(10n + \ln n)$.
            \item $\ln 2n \in \Theta(\ln 3n)$.
            \item $n (\ln n)^{2} \in \mathcal{O}(\frac{n^{2}}{\ln n})$.
        \end{enumerate}
    \end{enumerate}
\end{enumerate}

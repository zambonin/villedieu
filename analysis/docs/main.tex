...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item $2^{{(\lg n)}^{2}} \in \Omega((\log n)^{\log n})$, for $n_{0} > 1$ and $c = 1$. Additionally, $\lim_{n\to\infty} \frac{2^{{(\lg n)}^{2}}}{(\log n)^{\log n}} = \infty$.
            \item $n^{2} \in \Theta(n + n^{2})$, for $n_{0} > 1, c_{1} = \frac{1}{2}$ and $c_{2} = 1$. Additionally, $\lim_{n\to\infty} \frac{n^{2}}{n + n^{2}} = 1$.
            \item $n + (\log n)^{2} \in \Theta(10n + \lg n)$, for $n_{0} > 1, c_{1} = 1$ and $c_{2} = \frac{1}{11}$. Additionally, $\lim_{n\to\infty} \frac{n + (\log n)^{2}}{10n + \lg n} = \frac{1}{10}$.
            \item $\log 2n \in \Theta(\log 3n)$, for $n_{0} > 1, c_{1} = \frac{1}{2}$ and $c_{2} = 1$. Additionally, $\lim_{n\to\infty} \frac{\log 2n}{\log 3n} = 1$.
            \item $n (\log n)^{2} \in \mathcal{O}(\frac{n^{2}}{\log n})$, for $n_{0} > 2$ and $c = 1$. Additionally, $\lim_{n\to\infty} \frac{(\log n)^{3}}{n} = 0$.
        \end{enumerate}
    \end{enumerate}
    \item
    \begin{enumerate}

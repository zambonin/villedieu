...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Let $T(n) = T(\frac{9n}{10}) + n$, with $a = 1, b = \frac{10}{9}$ and $f(n) = n$. We have that $n^{\log_{\frac{9}{10}} 1} = 1$, $f(n) \in \Omega(n^{\log_{1} \frac{10}{9} + \epsilon})$ and $\frac{n}{2} \leq cn$ with \emph{e.g.} $\epsilon = c = \frac{3}{4}$. Thus, the third case may be applied, giving $T(n) \in \Theta(n)$.

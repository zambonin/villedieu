...
\begin{enumerate}
    ...
    \item
    \begin{enumerate}
        \item Let $P(n) = \sum_{i = 1}^{n} \frac{n (n + 1)}{2}$. $P(1)$ holds, since $\frac{1 (1 + 1)}{2} = 1$. The induction step is proved below, using the hypothesis that $P(k)$ is true.
        \begin{align*}
        ...
        \begin{align*}
            P(k) + (k + 1) &\stackrel{?}{=} P(k + 1) \\
            \frac{k (k + 1) (2k + 1)}{6} + (k + 1) &\stackrel{?}{=} \\
            \frac{k (k + 1) (2k + 1) + 6(k + 1)}{6} &\stackrel{?}{=} \\
            \frac{(k + 6)(k + 1)(2k + 1)}{6} &\stackrel{?}{=}
        \end{align*}
    \end{enumerate}
\end{enumerate}

...
\begin{align*}
    ...
    n &= \euler^{W(c \ln 2)}.
\end{align*}
Moreover, to invert the factorial function some definitions from~\cite{Cantrell:200110:misc} are used to construct a strict inverse, if the input is an integer. Consider $\psi($

...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        %   \end{scope}
          \end{tikzpicture}
        \end{figure}
        The costs are given shortly after.
        \begin{align*}
            T(1) &= 0 \\
            T(2) &= 2 + (2 \cdot 0) &\Rightarrow 2 + (2T(1)) \\
            T(4) &= 4 + (4 \cdot (2 + (2 \cdot 0))) &\Rightarrow 4 + (4T(2)) \\
            T(8) &= 8 + (8 \cdot (4 + (4 \cdot (2 + (2 \cdot 0))))) &\Rightarrow 8 + (8T(4)) \\
            &\vdots \\
            T(n) &= nT(\tfrac{n}{2}) + n.
        \end{align*}
    \end{enumerate}

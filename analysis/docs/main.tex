...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \end{align*}
    It is evident that the new input size had a modest growth. Indeed, the new computer will run slower if $n > 4$ with $n \in \mathbb{N}$. This is due to the fact that the complexity of $f(n)$ grows exponentially, while in this case, the computational power grew linearly. Ergo, one cannot execute $f(2n)$ and expect comparable results on $N_{2}$, since $n_{2} \ll 2 n_{1}$.
  \end{enumerate}
  \item 
  \begin{enumerate}
